...
public interface KitchenControllerOpenApi {
	...
	@ApiResponses({ @ApiResponse(code = 400, message = "Identificador da cozinha inválido", response = ApiError.class),
	...
	public KitchenDTO save(
			@ApiParam(name = "corpo", value = "Representação de uma nova cozinha") KitchenInput kitchenInput);
