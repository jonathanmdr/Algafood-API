...
import com.algaworks.algafood.api.v1.controller.GroupPermissionController;
...
import com.algaworks.algafood.api.v1.controller.OrderStatusController;
...
import com.algaworks.algafood.api.v1.controller.RestaurantPaymentFormController;
...
import com.algaworks.algafood.api.v1.controller.RestaurantUserManagerController;
import com.algaworks.algafood.api.v1.controller.StateController;
import com.algaworks.algafood.api.v1.controller.StatisticsController;
import com.algaworks.algafood.api.v1.controller.UserController;
import com.algaworks.algafood.api.v1.controller.UserGroupController;
...
public class AlgaLinks {
	...
	public Link linkToUserGroupAssociate(Long userId, Long groupId, String linkRelation) {
		return linkTo(methodOn(UserGroupController.class)
				.associateGroup(userId, groupId)).withRel(linkRelation);
	}
	
	public Link linkToUserGroupDisassociate(Long userId, Long groupId, String linkRelation) {
		return linkTo(methodOn(UserGroupController.class)
				.disassociateGroup(userId, groupId)).withRel(linkRelation);
	}
