...
create table produto (id bigint not null auto_increment, ativo bit not null, descricao varchar(255), nome varchar(255) not null, preco decimal(19,2) not null, restaurante_id bigint not null, primary key (id)) engine=InnoDB
create table restaurante (id bigint not null auto_increment, endereco_complemento varchar(255), endereco_bairro varchar(255), endereco_numero varchar(255), endereco_logradouro varchar(255), endereco_cep varchar(255), data_criacao datetime not null, taxa_frete decimal(19,2) not null, nome varchar(255) not null, data_atualizacao datetime not null, endereco_cidade_id bigint, cozinha_id bigint not null, primary key (id)) engine=InnoDB
create table restaurante_forma_pagamento (restaurante_id bigint not null, forma_pagamento_id bigint not null) engine=InnoDB
create table usuario (id bigint not null auto_increment, data_criacao datetime not null, nome varchar(255) not null, senha varchar(255) not null, primary key (id)) engine=InnoDB
